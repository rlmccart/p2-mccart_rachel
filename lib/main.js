...
var colorSectionTwo = document.getElementsByClassName('colorstwo');
var fortuneColor = document.querySelectorAll('.colors p');
var fortuneNumber = document.querySelectorAll('.numbers p');
var fortuneColorTwo = document.querySelectorAll('.colorstwo p');
...
for (var _i2 = 0; _i2 < fortuneNumber.length; _i2++) {
    fortuneColorTwo[_i2].addEventListener('click', functionWrapperThree);
};